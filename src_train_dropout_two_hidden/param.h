...
struct param 
{
	...
	std::string train_context_vectors_file;
	std::string validation_context_vectors_file;
	...
	double hidden1_dropout_value;
	double hidden2_dropout_value;
	double hidden3_dropout_value;
